...
/**
 * Package a Griffon application as a zip file.
 *
 * @author <a href="mailto:nielsbechnielsen@gmail.com">Niels Bech Nielsen</a>
 * @since 1.3
 */
@Mojo(name="maven-package-zip", requiresProject=true)
public class MvnPackageZipMojo extends MvnPackageApplicationMojo {
